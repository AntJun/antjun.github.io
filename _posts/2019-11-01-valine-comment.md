...
<img src="https://cdn.jsdelivr.net/gh/AntJun/BlogImageHosting/img/create app.png" alt="Create application" />{:.shadow}

在`设置` > `应用`中可查看到 APP ID 和 APP Key。

<img src="https://cdn.jsdelivr.net/gh/AntJun/BlogImageHosting/img/App Keys.png" alt="Get AppId and AppKey" />{:.shadow}
...
<img src="https://cdn.jsdelivr.net/gh/AntJun/BlogImageHosting/img/Secure domain.png" alt="Set up a secure domain name" />{:.shadow}

**注意：如在网站调试过程中出现关于调用 `api.leancloud.cn` 的 403 报错，说明服务器理解客户的请求，但拒绝处理它，这是由于服务器上文件或目录的权限设置导致的 WEB 访问错误。**
{:.warning}

<img src="https://cdn.jsdelivr.net/gh/AntJun/BlogImageHosting/img/403.png" alt="403 Error" />{:.shadow}
...
<img src="https://cdn.jsdelivr.net/gh/AntJun/BlogImageHosting/img/manage comment.png" alt="Comment Data Management" />{:.shadow}
...
<img src="https://cdn.jsdelivr.net/gh/AntJun/BlogImageHosting/img/valine comment.png" alt="Valine Comment" />{:.shadow}
...
<img src="https://cdn.jsdelivr.net/gh/AntJun/BlogImageHosting/img/gravatar.png" alt="Gravatar 01" />{:.shadow}

<img src="https://cdn.jsdelivr.net/gh/AntJun/BlogImageHosting/img/gravatar add.png" alt="Gravatar 02" />{:.shadow}
