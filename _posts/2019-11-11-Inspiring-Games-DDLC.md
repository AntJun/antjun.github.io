...
Doki Doki Literature Club（心跳文学部，以下简称 DDLC）是 Team Salvato 在 2017 年发布的视觉小说。这款游戏早在发行时我就体验过，尽管当时并没有完全通关，但已经对它的基本结构和氛围有了一定了解。最近由于 Steam UI 更新，把我之前许多放着吃灰的小游戏都直接显示在库内，我又重新玩了一遍这个特别的游戏。

这大概是我第一次接触到那么让我感到新颖的 Metagame，另一个则是 Undertale。

## 介绍

**注意：本文包含大量剧透和心理恐怖内容，建议通关后再阅读。**
{:.warning}

DDLC 在 Steam 商店页看起来像一款典型的二次元校园恋爱游戏：粉色主题、轻快音乐，再加上标准的社团与角色介绍，很容易让人误以为它只是在讲校园日常。
但 Steam 上的 `Psychological Horror` 标签已经提前揭露了它的另一面。相比于「灯穗奇谈」、「梦幻廻廊」或「尸体派对」这类更直接的恐怖作品，DDLC 并不依赖密集的惊吓桥段，而是通过逐渐失控的文本、界面和角色关系制造不适感。

我最早只是听过一些刻意隐藏真相的推荐，并没有详细了解游戏，只是被封面和「免费」二字吸引。小时候被「晴天娃娃」那集吓哭过的我，也没有想到这款看似明亮的游戏会给我类似的心理阴影。

开局与其它文字冒险游戏没有太大区别：主角与邻居 Sayori 一同上学，并在文学部成员的邀请下入部。文学部共有四位主要成员：部长 Monika、副部长 Sayori，以及 Yuri 和 Natsuki。按照 Monika 的提议，各成员每天都需要创作并交换诗作。但随着主角与部员关系逐渐升温，事情也慢慢变得不对劲。
...
graph TB;
	...
	A2["完成一周目后启动游戏"]
    B{"是否在 Sayori 自杀前 <br> 通过读档收集了 9 张 CG 立绘？"}
	C1["打开游戏后 <br> 直接跳转到 Sayori 上吊场景"]
	C2["30% 的概率在打开游戏后 <br> 看到四人曝光度异常的黑白立绘"]
	D["完成三周目"]
	E["完成三周目"]
	X["BE"]
	Y["NE"]
...
游戏中主角会通过在文学部互换诗作来增进与其他社员的关系，因此诗在全游戏中的比重非常大，可以说是游戏的核心内容之一。这也是它被戏称为「诗歌模拟器」的原因。

在游戏中，我们通过选择词语来写诗，并借此提升与不同社员的亲近度。每当选择某个词语时，偏好该词语风格的角色就会跳起来，这也是游戏前期最直观的攻略反馈。进一步观察每位成员的诗，可以发现诗作与她们的性格、心理状态和剧情走向密切相关，越到后期表达越强烈。

![写诗界面](https://cdn.jsdelivr.net/gh/AntJun/BlogImageHosting/img/write%20your%20poem.png){:.shadow}
...
![Sayori 诗作 1](https://cdn.jsdelivr.net/gh/AntJun/BlogImageHosting/img/Sayori%20Poem%2001.png){:.image .image--sm .shadow}

这首抒情诗是 Sayori 在早晨上学前写的，从最后一句可以看出这一点。Sayori 有早晨睡过头的习惯，主角也经常负责叫醒她，所以这首诗表面上像是在表达对主角的感激。

我们可以结合后续主角安慰 Sayori 的剧情重新审视这首诗：
...
不难发现，Sayori 的这首诗真正表达的是她被抑郁症困扰，以至于无法面对每一天；这也正是她经常睡过头的原因。而“我将长眠”则意指结束自己的生命。

当然，这首诗也只是揭示 Sayori 抑郁症状态的一段小插曲。

---

#### Monika 3 ARC 1 / 1 ARC 2

![Monika 诗作 1](https://cdn.jsdelivr.net/gh/AntJun/BlogImageHosting/img/Monika%20Poem%2001.png){:.image .image--sm .shadow}
![Monika 诗作 2](https://cdn.jsdelivr.net/gh/AntJun/BlogImageHosting/img/Monika%20Poem%2002.png){:.image .image--sm .shadow}

`Save Me`、`Load Me`、`Delete Her` 都是在暗示玩家处理游戏目录下的 `characters` 文件夹。在「Monika 的今日写作小窍门」中，她也会提醒玩家保存游戏：

> “有时候你会发现自己面临着不同的选择……这时候，不要忘记保存游戏哦！”

这些看似奇怪的提示，其实是在暗示玩家后续需要通过读档、删除角色文件等方式推进剧情，也进一步揭示了 Monika 与其他角色的不同。

---

#### Natsuki 1 ARC 2

![Natsuki 诗作](https://cdn.jsdelivr.net/gh/AntJun/BlogImageHosting/img/Natsuki%2001.png){:.image .image--lg .shadow}

如果了解 Base64，应该很快就能判断这首诗需要先解码。解码后的原文如下：

> 睁开你的第三只眼
>
> 可以通过刀感受到她皮肤的柔嫩，仿佛那是我触觉的延伸。我的身体几乎抽搐。在内心深处，有一种难以置信的微弱的东西在尖叫，以抵抗这种无法控制的快乐。但我已经可以说，我正在被逼到崩溃的边缘。我无法……我无法阻止自己。

那么，第三只眼是什么？Natsuki 这段字符又为什么会出现在 Natsuki 的诗中？

---

#### Yuri 1/2 ARC 2

![Yuri 诗作 1](https://cdn.jsdelivr.net/gh/AntJun/BlogImageHosting/img/Yuri%20Poem%2001.png){:.image .image--sm .shadow}
![Yuri 诗作 2](https://cdn.jsdelivr.net/gh/AntJun/BlogImageHosting/img/Yuri%20Poem%2002.png){:.image .image--sm .shadow}
![Yuri 诗作 2 处理后](https://cdn.jsdelivr.net/gh/AntJun/BlogImageHosting/img/Yuri%20Poem%2002X.png){:.image .image--sm .shadow}

在我看来，论最吓人的女主还是得说到 Yuri。她虽然没有 Monika 那样直接干预游戏的能力，却被制作者埋下了最多秘密。

只用「病娇」或「自残」并不足以概括 Yuri，她的背景被写得更复杂。这两首诗给我的感觉像是她在极度激动的状态下写出的狂想诗：前一首至少能看清，后一首则像一张被血液和尿液污染的纸，几乎无法辨认她想表达什么。

《轮》这首诗表现的是 Yuri 的内心波动，就像滚动的轮子一样不停翻转。看起来有人在逼迫她？没错，那就是她在 Monika 的持续影响下逐渐失控后产生的狂热、扭曲心理。

第二首诗有人发现是使用一种叫 Damagrafik Script 的字体写的。在结尾能译出一段话来（但我仍不知道它上部分是什么意思）：
...
这与上面 Natsuki 的「乱码诗」互相连接，更像是一则杀人故事的碎片。

---

#### Special Poem

![Special Poem 原图](https://cdn.jsdelivr.net/gh/AntJun/BlogImageHosting/img/special%20poem01.jpg){:.image .image--lg .shadow}
![Special Poem 调整曝光后](https://cdn.jsdelivr.net/gh/AntJun/BlogImageHosting/img/special%20poem01x.png){:.image .image--lg .shadow}

游戏中有 11 首特别诗，这是其中一首。左图为原图，其中被涂黑的部分可以通过调高曝光度显示出来（如右图所示）。

观察原图可以看到 13 个字母，连起来是 *Nothing is real*。

但阅读原文会发现里面提到了 Elyssa 和 Renier 这两个与 DDLC 本篇角色无直接关系的名字。作者像是涉入了一个病态家庭：Elyssa 的惨叫、Renier 的存在，以及叙述者对这一家的怀疑，都把它引向了另一个尚未完全展开的故事。

---

### 只属于你的 Monika

众所周知，Monika 是游戏中打破第四面墙的角色。即使她看起来再接近现实，本质上仍是一组被写好的程序和参数；但毫无疑问，Monika 就是这个游戏的核心人物。
...
>
> “但所有这些外界给予的压力，外加荷尔蒙的作祟，可能会导向人生中相对低潮的一段时光。”
>
> “每个人都拥有自己的故事。”
>
> “你无法纯看表面就理解到一个人内心的思想。”
...
[EstasVii](https://weibo.com/u/2436385964){:.button .button--outline-success .button--pill target="_blank" title="Translator"}

<details class="card" markdown="1">
<summary>展开 yuri.chr 解码译文（内容含暴力描写）</summary>
...
我告诉你这些背景信息是因为一种奇怪的误解一直存在着，认为如果你想杀死某人的话那你要么脑袋有毛病，要么你的愤怒管理没做好。但是，很显然我并不属于这两类。绝大多数谋杀案是某人在家庭环境中无法控制自己的愤怒之类的情绪而犯下的，这话没错，但要知道这些人是在刺激下杀人的，要么是受某次突发的刺激，要么是被一系列慢慢发作的不幸刺激。这些人杀人是因为在那个短暂的时刻里，他们想要某个特定的人，因为某个特定的原因受伤或者死亡。
...
现在，刚刚体验过杀人后，我会说这最终相当令人满意。我会再试一次吗？大概不会吧，因为我的好奇心已经得到了满足，第二次感觉就不一样了。
...
我一进大学就有了观察别人的爱好。我觉得观察别人相当有趣，因为这就像是从你生命中那些茫茫过客里挑出一个，然后让他们变成主角，当然了，是在他们毫不知情的情况下。每天经过你的上百个陌生人之中，每一个人都和你一样，有着深刻而复杂的人生故事，这点很容易被人忘记。关于观察别人和渴望杀人呢，我注意到一点，那就是你会对它越来越有体悟。当我找人来观察的时候，他们的故事在我眼里会随着时间的推移变得渐渐清晰，我和他们之间的隔阂被打破了，这真的很棒。
...
我开始有点失去耐心，并想过干脆就杀那个叫 Devon 的男人好了，即便我不是很想杀富有的人。但接着，我碰到了一个新的目标，一个感觉几乎完美的目标。这种感觉随着我对她的进一步调查只增不减。我知道她会是那个被我杀死的人。

一个年轻面貌的女人，在杂货店被我碰见，和我平常做得一样。她当时拎着篮子在买小玩意儿。她的头发是深棕色的大波浪，随意落在她塌塌的肩上。她手上没戴戒指，这告诉我她或许孤身一人，不是或许，我几乎可以确定她是单身的。这个女人就是如此地……普通。我猜自从我开始观察别人以后，我对陌生人的私人生活越来越敏锐了。从她“自食其力”这一点看，我觉得就算她突然死掉了，也不会有人来追悼她的。当然，我当时仍然想要进一步调查她。

我像我平时做的那样在她出去工作的时候检查她的居所。我马上就从她的邮件中得知她的姓名是 Linda Watson。Linda 住在一个安静的公寓大楼里，她的邮箱就在她的门外垂手可及。我决定把她的邮件带回自己的寝室，并在她下班前还回去（她住在离我只 15 分钟路程远的地方），而非草草翻看一下。我研究了一下如何在不破坏信封的前提下打开并重新封好这些邮件，这需要一点技巧，还有电吹风、酒精以及棉签。
...
但我当时我的斧刃是朝后的，我用斧头钝的一侧打中了她。其实我是故意如此，因为当时我不知怎么的，觉得这是能让她发出最少声音的办法。它奏效了，我几乎没有在挥舞的斧头和她的脑袋碰撞时感到什么阻力，干脆利落地就把她的脑袋锤到一边。Linda 喉咙里刚酝酿了一半的音节化作一声奇怪的咕哝，要我说大概是呼气的声音。与此同时，她的头受到巨力的迫使，撞上了橱柜，然后她无法保持自己的平衡向后倒去。在她半落在空中时，我并没有犹豫而是继续挥舞着斧子，这次是斧刃朝向正确的方向。我不知道瞄准哪里，所以我开始劈砍她的锁骨还有胸膛。感觉起来斧子没有进得太深，但是每当斧子嵌入她的身体我都清楚地听到了哐哐的声音，我甚至感受到了这种柔韧的触感传递到我的手上，斧子仿佛是我触觉实实在在的延伸。
...
那里有很多搜索记录，像“自杀的方法”，“如何打一个套索结”，“危险的家用化学产品”，“煤气中毒”……还有好多这样的。她看完这些搜索都可以写一本关于自杀的书了。所以我猜 Linda 在考虑自杀。我好奇是否是因为她的抑郁症。
...
我最后把笔记本电脑还有其他东西也丢到垃圾箱里。此时距事发已经几个小时了，所以我有时间冷静下来好好回味这一切，正如我说的，这相当令人满足，我很开心我终于把这事搞定了。我觉得我终于可以把这件事从我的遗愿清单中划掉了，或者说我像是完成了一件不是很重要但是却一直膈应着自己的事。这可能是我最后一次写到 Linda Watson 的名字了，接下来是时候回归正常的大学生活了，除了我可能偶尔还会观察一下别人，因为这让我觉得相当好玩有趣。
...
这里引用一下 [Mithost](https://www.reddit.com/user/Mithost/){:target="_blank"} 的方法。

> 将图片中间的黑白块视为 0 和 1（也就是二进制），从上至下依次转出来。
> 接着使用 Alphanumeric 转换器可以转换出 Base64 字符串，再解密一下可以得到一封信：

[Dan Salvato](https://twitter.com/dansalvato){:.button .button--outline-success .button--pill target="_blank" title="Author"}
[Vortex_K](https://tieba.baidu.com/home/main?un=Vortex_K&ie=utf-8&id=tb.1.c8d380a5.m_xDng4PwARBznaRicg1_w?t=1419504273&fr=pb){:.button .button--outline-success .button--pill target="_blank" title="Translator"}

<details class="card" markdown="1">
<summary>展开 monika.chr 解码信件</summary>
...
> “基本上就是关于一个变成了‘人体实验监狱’的宗教营……被困在那里的人们都有一个特点，那就是他们会变成渴望鲜血的杀人机器。
> 但是不仅如此，还会变得更糟糕，他们会选择性地繁殖一些人，方法就是砍掉他们的四肢，然后把他们附加到……”
...
[JisuArt](https://twitter.com/JisuArt){:.button .button--outline-success .button--pill target="_blank" title="Author"}
