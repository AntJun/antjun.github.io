...
本博客网站主要用于记录自己的想法，并没希望有多少人能看到我写的文章，尽量不封锁自己的文章，毕竟建了 Blog，寻思着能分享下自己的同时认识新伙伴，也并不算一件可耻的事。
{:.info}
...
该站属于 Ant_Jun 唯二的独立博客，且网站一切权利归属于本人。
...
常用 Ant Jun 作为网名。Akira 是自取的英文名（其实只是个罗马音）本人也用 Akira Kotori、Akira Ant 作为昵称。

### 称呼来源

Ant 是我曾在网络游戏中首次加入的组织名，其一直延用至今，
Akira 我也忘了怎么来的了……日语中“破晓”的意思，
Kotori 来自南小鸟/五河琴里的名字的罗马音，单纯喜欢南小鸟拿来用的。

## 生活

没什么特别的，希望别有人闲的没事开我盒，我啥也不是。
...
总之在各方面都没深入，并没有擅长的东西，如果我说过那一定是我在故意瞎扯。

- ACGN
  - 算是个 LLer，对 ACG 文化略知一二
- 打电动
  - FPS、TPS、RPG 及 GAL 为主，偶尔会和朋友打打联机
- 视频制作
  - 许多半成品
- 3D 动画
  - C4D, MMD 为主
- 网站前端及后端开发
  - 学过 JS 和各大数据库基础
- 搞机
  - 兴趣使然，常搞点主机、VPS、开发板和刷机等。
- 网络安全
  - 脚本小子
- 软件工程
  - C/Cpp, Python, Java 程序员，用编程技术解决问题
- AI
  - 探索 AI 绘图，自搭建开源模型平台以及高强度语言模型使用

## 性格

其实我自己也不好评价自己的性格，因此这里就不论真实性随便写写了。

个人比较内向，现实中就喜欢沉默不语，但我在网络上也不会重拳出击，而只是在能找到共同话题的地方瞎插几句话罢了。你可能发现我注册的账户基本上都没有可看的消息，大多都是除个人资料外空白一片。一种原因是我个人利己的性格，只在内心想想而不留下评论，只默默添加至收藏而不点赞；另一种就是有些完美主义者，担心没弄好会遇到来自他人的麻烦，所以我经常使用“大概”、”可能“这些词，虽然我知道这些词使用在技术类文档中使用是不合适的，就促使了我不得不再三的校验资料的真实性。所以为了嫌麻烦，我就压根不再创作，或是创作了却不发布。（~~其实也都说不准~~）

个人偏悲观现实主义。不善于交往，在语言表达能力方面有欠缺，~~不会大吼大叫~~。社会敏感问题上保持中立态度。

## 联系我

出于某些原因本人不会及时回复消息尊请谅解（其实主要看我心情）。对于长时间不冒泡的现象不一定是我死了，也可能只是暂时隐退。

### 网站及平台

我在各个网站或应用上注册的用户很多，出于安全问题，并不是所有的我都愿意公开，你可以在以下地方联系到我。
        ...
        <div class="item">
          <div class="item__content">
            <div class="item__description">
              <p>
                <h2>
                  <a href="https://www.kotori.space/" target="_blank"> Wordpress 个人博客</a>
                </h2> Ant Sevice (ME) 下的个人博客
              </p>
            </div>
          </div>
        </div>
...
暂时只公布两个，如果你知道我其它的邮箱地址的话（比如 Outlook），用其联系我也是没问题的。
